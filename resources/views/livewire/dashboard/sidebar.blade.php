<aside class="relative bg-primary h-screen w-64 hidden sm:block shadow-xl">
    <div class="p-6">
        <a href="" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">{{ Auth::user()->role_id == 3 ? 'Admin' : 'Seller' }}</a>
    ...
    <nav class="text-white text-base font-semibold pt-3">
        ...
        <a href="{{ route('dashboard.shop.update') }}" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
        ...
        @can('admin')
        {{-- active-nav-link --}}
        <a href="{{ route('dashboard.transaction.index') }}"  class="flex items-center  text-white py-4 pl-6 nav-item">
